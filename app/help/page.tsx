      ...
      <div className="pb-6">
        ...
        <HelpCard icon={<IconQuestion />} title="FAQ">
          <div className="space-y-3">
            ...
            <div>
              <h3 className="font-bold text-gray-800 text-sm mb-1">「通信エラー」「再試行」と表示される</h3>
              <p className="text-xs text-gray-600">
                サーバーが一時的にスリープ状態の場合、接続に時間がかかることがあります。「再試行」ボタンを押すと再接続を試みます。通常1〜2回の再試行で接続できますので、しばらくお待ちください。Wi-Fiやモバイル通信が安定しているかもご確認ください。
              </p>
            </div>
          </div>
        </HelpCard>
